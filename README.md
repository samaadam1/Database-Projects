...
A complete web-based Car Rental System built with **HTML**,**JavaScript**, **PHP** and **MySQL**, providing separate **Admin** and **Customer** interfaces to manage car rentals, reservations, and payments. The system includes user authentication, dashboards, search functionality, reservation, and payment processing.
